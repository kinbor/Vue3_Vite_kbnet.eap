...
import productServer from '@/configs/product/server'
...
const service = axios.create({
  baseURL: funcHttpx.genBaseUrl(productServer.product_svcAddress), // url = base url + request url
  withCredentials: false, // send cookies when cross-domain requests
  timeout: productServer.product_svcTimeout // request timeout
})
